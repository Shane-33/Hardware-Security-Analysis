...
void serial_echo_init(void)
{
    ...
    serial_echo_outb(serial_echo_inb(UART_DLM), UART_DLM);
    serial_echo_outb(serial_echo_inb(UART_DLL), UART_DLL);
     ...
     * registers */
    serial_echo_inb(UART_LSR); /* COM? LSR */
    serial_echo_inb(UART_RX);   /* COM? RBR */
